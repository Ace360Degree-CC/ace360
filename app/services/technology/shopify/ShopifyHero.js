    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Build, Launch & Scale Your Online Store
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            Take your ecommerce business to the next level with a
            high-performing
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            conversion-optimized Shopify store. At Ace360degree, we design and
            develop custom Shopify websites that offer a seamless shopping
            experience, mobile responsiveness, and powerful backend management
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/technology/shopify/world-data.png"
            alt="word-data"
            width={500}
            height={400}
