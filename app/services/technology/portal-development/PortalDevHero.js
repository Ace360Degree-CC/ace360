...
export default function PortalDevHero() {
  return (
    <section
      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            Visual storytelling is key to making a lasting impression.
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            At Ace360degree, we craft high-impact, creative, and strategically
            designed graphics that enhance brand identity, boost engagement, and
            communicate your message effectively across digital and print
            platforms.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/technology/portal-development/portal-development.png"
            alt="Logo Design"
            width={500}
            height={400}
