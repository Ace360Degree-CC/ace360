      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            In today’s digital-first world, a high-performing mobile app is
            essential for engaging users and driving business growth.
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            At Ace360degree, we specialize in developing custom iOS and Android
            apps that are intuitive, scalable, and designed for success.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/technology/mobile/mobile.png"
            alt="Logo Design"
            width={500}
            height={400}
