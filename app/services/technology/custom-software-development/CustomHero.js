      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            our custom software solutions are designed to streamline operations,
            enhance productivity, and drive growth. At Ace360degree, we develop
            scalable, secure, and high-performance software tailored to your
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/technology/custom-sd/tab.png"
            alt="Logo Design"
            width={500}
            height={400}
