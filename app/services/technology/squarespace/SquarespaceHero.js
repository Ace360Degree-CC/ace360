    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Stunning, User-Friendly & Impactful
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            Create a visually stunning, high-performance website with
            Squarespace’s intuitive design and powerful CMS
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            At Ace360degree, we develop custom, mobile-responsive Squarespace
            websites that enhance brand presence, improve user experience, and
            drive conversions.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/technology/squarespace/squarespace-logo.png"
            alt="word-data"
            width={500}
            height={400}
