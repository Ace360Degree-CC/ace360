      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            it should be visually stunning, user-friendly, and optimized for
            conversions. At Ace360degree, we create high-performing,
            SEO-friendly, and mobile-responsive websites that drive engagement,
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/technology/web-development.png"
            alt="Logo Design"
            width={500}
            height={400}
