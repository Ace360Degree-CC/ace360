...
export default function ORMHero() {
  return (
    <section
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Protect & Enhance Your Brand with Online Reputation Management (ORM)
          </h2>
          ...
          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            At Ace360degree, we help businesses monitor, manage, and protect
            their digital presence, ensuring that positive brand narratives
            dominate search results while mitigating any negative impact. Our
            strategic ORM solutions build trust, credibility, and long-term
            brand resilience.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/digital-marketing/orm/5-star.png"
            alt="Logo Design"
            width={500}
            height={400}
