    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Rank Higher, Drive Traffic & Boost Conversions with Expert SEO
            Services
          </h2>
          ...
          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            Our data-driven SEO strategies help businesses increase online
            visibility, organic traffic, and customer conversions. With
            Ace360degree, your website isn’t just optimized—it’s built to
            dominate search results and bring in qualified leads.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/digital-marketing/seo/search-engine-optimization.png"
            alt="Logo Design"
            width={500}
            height={400}
