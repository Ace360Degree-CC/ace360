...
export default function BrandNamingHero() {
  return (
    <section
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Create a Memorable Identity with Expert Brand Naming Services
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            Your brand name is the foundation of your identity
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            it defines who you are, what you stand for, and how your audience
            perceives you. At Ace360degree, we craft unique, memorable, and
            impactful brand names that resonate with your target market and
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/branding/brand-naming/brand-naming.png"
            alt="three-dimensionol-mask"
            width={500}
            height={400}
