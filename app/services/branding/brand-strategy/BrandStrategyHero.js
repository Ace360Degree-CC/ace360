...
export default function BrandStrategyHero() {
  return (
    <section
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Build a Strong Foundation with Expert Brand Strategy Services
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            A successful brand is more than just a logo
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            it’s a carefully crafted strategy that defines your identity,
            values, and market positioning. At Ace360degree, we develop
            data-driven brand strategies that help businesses create a
            compelling presence, build customer loyalty, and drive long-term
            success.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/branding/brand-strategy/brand.png"
