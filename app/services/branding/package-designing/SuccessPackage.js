export default function SuccessPackage() {
  return (
      ...
      <div className="flex justify-center">
        <div className="grid md:grid-cols-3 gap-8 ">
          ...
          <div className="bg-[#FBE4B5] w-60  p-6 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/package-designing/proven.png"
                alt="Proven Results"
            ...
            <p className="text-gray-800">
              Increased Sales by 40% with Eye-Catching Packaging
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6 w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/package-designing/data-driven.png"
                alt="Data Driven"
                className="mx-auto w-24 h-24"
              />
            </div>
            ...
            <p className="text-gray-800">
              Successfully Launched a New Product with Premium Box Design
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6  w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/package-designing/tailor-solution.png"
            ...
            <p className="text-gray-800">
              Enhanced Customer Experience with Sustainable Packaging Solutions
            </p>
          </div>
        </div>
      </div>
