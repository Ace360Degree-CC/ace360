      ...
      <div className="flex justify-center">
        <div className="grid md:grid-cols-3 gap-8 ">
          ...
          <div className="bg-[#FBE4B5] w-60  p-6 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/video-editing/proven-result.png"
                alt="Proven Results"
            ...
            <p className="text-gray-800">
              Boosted Social Media Engagement by 5X with Short-Form Videos
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6 w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/video-editing/datadriven-approch.png"
                alt="Data Driven"
                className="mx-auto w-24 h-24"
              />
            </div>
            ...
            <p className="text-gray-800">
              Increased Product Sales by 70% with an Explainer Video
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6  w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/video-editing/tailor-solutions.png"
            ...
            <p className="text-gray-800">
              Enhanced Brand Credibility with High-Quality Corporate Videos
            </p>
          </div>
        </div>
      </div>
