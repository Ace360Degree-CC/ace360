    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Transform Your Content into Engaging Visual Stories
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            In a world where video content dominates, professional editing makes
            all the difference.
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            At Ace360degree, we create high-quality, engaging, and impactful
            videos that capture attention, tell compelling stories, and drive
            results.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/branding/video-editing/video-edititor.png"
