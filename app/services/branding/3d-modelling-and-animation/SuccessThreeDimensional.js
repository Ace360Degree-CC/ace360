      ...
      <div className="flex justify-center">
        <div className="grid md:grid-cols-3 gap-8 ">
          ...
          <div className="bg-[#FBE4B5] w-60  p-6 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/three-dimensionol/proven.png"
                alt="Proven Results"
          ...
          <div className="bg-[#FBE4B5] p-6 w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/three-dimensionol/data-driven.png"
                alt="Data Driven"
                className="mx-auto w-24 h-24"
              />
            </div>
          ...
          <div className="bg-[#FBE4B5] p-6  w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/three-dimensionol/tailor-solution.png"
            ...
            <p className="text-gray-800">
              Elevated Brand Storytelling with Motion Graphics
            </p>
          </div>
        </div>
      </div>
