    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Bring Ideas to Life with 3D Modeling & Animation
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            Want to showcase your products, designs, or concepts in a visually
            engaging way?
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            Our 3D modeling and animation services transform ideas into
            stunning, lifelike visuals that captivate audiences, enhance brand
            storytelling, and boost engagement.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/branding/three-dimensionol/three-dimensionol-mask.png"
