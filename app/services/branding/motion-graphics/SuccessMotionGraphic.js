      ...
      <div className="flex justify-center">
        <div className="grid md:grid-cols-3 gap-8 ">
          ...
          <div className="bg-[#FBE4B5] w-60  p-6 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/motion-graphic/proven.png"
                alt="Proven Results"
            ...
            <p className="text-gray-800">
              Increased Social Media Engagement by 300% with Motion Graphics
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6 w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/motion-graphic/data-driven.png"
                alt="Data Driven"
                className="mx-auto w-24 h-24"
              />
            </div>
            ...
            <p className="text-gray-800">
              Boosted Website Conversions with Animated Explainer Videos
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6  w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/motion-graphic/tailor-solution.png"
            ...
            <p className="text-gray-800">
              Achieved 5X More Clicks on Ads with Motion-Based Content
            </p>
          </div>
        </div>
      </div>
...
export default SuccessMotionGraphic;
