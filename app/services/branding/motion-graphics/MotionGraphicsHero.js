    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          ...
          >
            Captivate & Engage with High-Impact Motion Graphics
          </h2>

          <p className="text-4xl font-abril mt-4" style={{ color: "#F2A300" }}>
            Static visuals can only do so much—motion graphics bring your brand
            to life.
          </p>

          <p className="mt-4" style={{ color: "var(--theme-text)" }}>
            At Ace360degree, we craft engaging, high-quality animated visuals
            that captivate audiences, simplify complex ideas, and boost
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            src="/images/services/branding/motion-graphic/motion-graphic.png"
            alt="motion-graphic"
            width={500}
            height={400}
