      ...
      <div className="flex justify-center">
        <div className="grid md:grid-cols-3 gap-8 ">
          ...
          <div className="bg-[#FBE4B5] w-60  p-6 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/logo-design/proven.png"
                alt="Proven Results"
            ...
            <p className="text-gray-800">
              Designed a Unique Logo That Boosted Brand Recognition by 70%
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6 w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/logo-design/data-driven.png"
                alt="Data Driven"
                className="mx-auto w-24 h-24"
              />
            </div>
            ...
            <p className="text-gray-800">
              Successfully Rebranded with a Modern Logo & Increased Engagement
            </p>
          </div>
          ...
          <div className="bg-[#FBE4B5] p-6  w-60 rounded-tl-2xl rounded-br-2xl shadow-md">
            <div className="mb-4">
              <img
                src="/images/services/branding/logo-design/tailor-solution.png"
            ...
            <p className="text-gray-800">
              Created an Animated Logo That Enhanced Digital Presence
            </p>
          </div>
        </div>
      </div>
