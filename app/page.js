        ...
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center p-8">
          ...
          <div>
            ...
            <p className="text-[#444444] mb-6">
              ...
              marketing, creative branding, and cutting-edge technology
              solutions. Strengthen your brand, boost visibility, and engage
      ...
      <div className="bg-[#ffffff] py-12 px-6 flex justify-center">
        <div className="max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-[#212529] mb-4">
            Drive Results with{" "}
            <span className="text-[#F2A300]">Data-Driven</span> Digital
            Marketing Services
          </h2>
          <p className="text-[#212529] text-lg">
            At Ace360degree, we help businesses grow with expert digital
            strategies. Elevate your online presence, engage your audience, and
            ...
            {[
              {
                ...
                desc1:
                  "Improve rankings, boost traffic, and grow your online presence.",
              ...
              },
              {
                ...
                desc1:
                  "Engage audiences, increase followers, and drive brand awareness.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Connect with influencers to enhance credibility and reach.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Create compelling, SEO-friendly content that drives engagement",
                desc2: "Learn More about ",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc1:
                  "Build a strong brand foundation with strategic planning.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Design impactful logos that represent your brand identity.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Develop engaging brochures, flyers, and business materials.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Craft visually compelling designs for brand communication.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Create attractive packaging that enhances product appeal.",
                desc2: "Learn More about ",
            ...
            {[
              {
                ...
                desc1:
                  "Build responsive, high-performing websites for your business.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Develop tailored software solutions for business efficiency.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Launch powerful online stores for seamless shopping experiences.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                desc1:
                  "Build scalable portals for businesses and online marketplaces.",
                desc2: "Learn More about ",
              ...
              },
              {
                ...
                title: "SquareSpace",
                desc1:
                  "Stunning, user-friendly Squarespace websites built for impact.",
                desc2: "Learn More about ",
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-[#525252] text-sm md:text-base">
              We'll even go so far as to provide them with resources if they
              need it, or help them find the right people for their needs. We're
              here to make sure your business keeps running smoothly, and we
              want you to feel like you can ask us anything!
            </p>
          </div>
      ...
      <div className="bg-white py-12 px-4">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-y-10">
          {[
            ...
            <div
              key={index}
              className="w-1/2 sm:w-1/3 md:w-1/6 flex justify-center"
            >
              <img
                src={logo}
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-md p-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2 mb-6 md:mb-0">
            ...
            <p className="text-[#525252] mb-4 text-sm">
              We're Thane's best digital marketing company in Mumbai and PAN
              India — with a focus on innovative and effective solutions.
            </p>
            <p className="text-[#525252] mb-6 text-sm">
              We help businesses achieve their goals by putting together the
              right content, strategy, and technology to make their brand come
              to life.
            </p>
